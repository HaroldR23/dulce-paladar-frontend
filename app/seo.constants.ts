...
export const localBusinessSchema = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Tortas de Cumpleaños personalizadas' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Tortas Infantiles personalizadas' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Tortas de Bodas' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Cupcakes artesanales' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Galletas decoradas' } },
      { '@type': 'Offer', itemOffered: { '@type': 'Product', name: 'Mesas dulces' } },
    ],
  },
  sameAs: [],
